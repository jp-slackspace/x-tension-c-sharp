...
namespace XTensions
{
    ...
    public struct SearchPreparationInformation
    {
        ...
        [MarshalAs(UnmanagedType.LPWStr)] public string lpSearchTerms;
    ...
    public struct EventInformation
    {
        ...
        public IntPtr hEvidence;
        /// <summary>Event type.</summary>
        public int nEvtType; // need enum for this
        public uint nFlags; // need enum for this
        ...
        [MarshalAs(UnmanagedType.LPWStr)] public string lpDescr;
    };
    ...
    public struct CodePages
    {
        /// <summary>Size of the packed record.</summary>
        public int iSize;
        public ushort nCodePage1;
        public ushort nCodePage2;
        public ushort nCodePage3;
        public ushort nCodePage4;
        public ushort nCodePage5;
    };
